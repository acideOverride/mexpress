...
- [x] Create feature branch from appropriate milestone branch:
  ```bash
  git checkout milestone/MS-MEXP-014-shared-service-components
  git checkout -b feature/MEXP-2025-082-BE-email-service
  ```
- [x] Initial commit with CHECKLIST.md creation:
  ```bash
  git add docs/mexpress/TASKS.md docs/mexpress/CHECKLIST.md
  git commit -m "task(TASK-MEXP-082): start email service component implementation"
  ```
...
- [x] **Commit test files**:
  - [x] Stage test files: `git add packages/email-service/tests/`
  - [x] Commit: `git commit -m "test(email): add tests for email service component"`
...
- [x] **Commit implementation**:
  - [x] Stage implementation files: `git add packages/email-service/src/`
  - [x] Commit: `git commit -m "feat(email): implement email service component"`
...
- [x] **Commit refactoring**:
  - [x] Stage refactored files: `git add packages/email-service/src/`
  - [x] Commit: `git commit -m "refactor(email): optimize email service performance"`
...
- [x] **Final updates**:
  - [x] Archive CHECKLIST.md to checklist_history:
    ```bash
    cp docs/mexpress/CHECKLIST.md docs/mexpress/checklist_history/CHECKLIST-TASK-MEXP-082-Email-Service-Component-$(date +%Y%m%d).md
    ```
  - [x] Update TASKS.md status to "Completed"
  - [x] Update MILESTONES.md progress if needed
  - [x] Update component registry files (already done)
  - [x] Commit completion:
    ```bash
    git add docs/mexpress/checklist_history/* docs/mexpress/TASKS.md docs/mexpress/MILESTONES.md
    git commit -m "complete(TASK-MEXP-082): finish email service component implementation"
    ```
  - [x] Push branch and prepare for PR:
    ```bash
    git push -u origin feature/MEXP-2025-082-BE-email-service
    ```