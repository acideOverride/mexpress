...
| Test Results | COMPLETE | `/opt/mExpress/projects/montpc_crm/frontend/tests/results/summary/test-results.json` |
| Test Metrics | COMPLETE | `/opt/mExpress/projects/montpc_crm/frontend/tests/results/summary/test-metrics.json` |
...
| DEBUGGER Resolution | COMPLETE | `/opt/mExpress/docs/core/projects/mexpress/tasks/handoffs/DEBUGGER-CODE-CUST-2-resolution.md` |
