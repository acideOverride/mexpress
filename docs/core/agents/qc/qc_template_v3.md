                ...
                <template>
                    ...
                    REQUIREMENTS:
                        Package Architecture:
                            ...
                            - Integration Points: ${package_integration}
                            - Package Docs: ${package_documentation}

                        Monorepo Architecture:
                            - Build System: ${build_system_design}
                            - Shared Resources: ${shared_resources_design}
                            - Cross-Package Deps: ${cross_package_deps}
                            - Integration Patterns: ${integration_patterns}
                            - Version Alignment: ${version_alignment}
                            - System Docs: ${system_documentation}
        ...
        <task_completion>
            <format>
                <template>
                    ...
                    FINDINGS:
                        Package Architecture:
                            - API Design: ${package_api_status}
                            - Breaking Changes: ${breaking_changes_status}
                            - Version Strategy: ${version_strategy_status}
                            - Dependencies: ${package_deps_status}
                            - Integration Points: ${package_integration_status}
                            - Package Docs: ${package_docs_status}

                        Monorepo Architecture:
                            - Build System: ${build_system_status}
                            - Shared Resources: ${shared_resources_status}
                            - Cross-Package Deps: ${cross_package_deps_status}
                            - Integration Patterns: ${integration_patterns_status}
                            - Version Alignment: ${version_alignment_status}
                            - System Docs: ${system_docs_status}
        ...
        <verification_patterns>
            <pattern>
                ...
                <verification_sequence>
                    ...
                    2. Monorepo Architecture Verification
                       - Build system architecture
                       - Shared resource patterns
                       - Cross-package dependency design
                    ...
                    4. Integration Approach Validation
