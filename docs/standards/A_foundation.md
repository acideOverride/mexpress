...
│   ├── A_foundation.md          # Foundation standards
│   ├── B_architecture.md        # Architecture standards
│   ├── C_development_principles.md # Development standards
│   ├── D_quality_security.md    # Quality and security standards
│   ├── E_agent_standards.md     # Agent workflow standards
│   └── F_project_documentation.md # Project documentation standards
│
└── projects/                    # All projects root
    ├── mexpress/               # Core framework project
...
### Documentation Types
1. Project Documentation (See F_project_documentation.md)
   - Project-wide documentation
   - High-level architecture
   - Project progress tracking
   - Decision records

2. Agent Documentation (Current section)
