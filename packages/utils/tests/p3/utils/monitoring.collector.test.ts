 ...
 * 
 * This test validates the functionality of the MetricsCollector class,
 * which provides a simple way to record and analyze metric data.
 */
...
/**
 * Implementation of MetricsCollector for testing
 * This matches the implementation in src/monitoring.ts but is defined
 * locally to avoid import path issues with different Jest configurations
 */
