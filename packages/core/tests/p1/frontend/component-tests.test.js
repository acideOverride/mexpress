...
const StyleValidator = {
  validateColors(componentColors, themeColors) {
  ...
  validateTypography(componentTypography, themeTypography) {
  ...
  validateSpacing(componentSpacing, themeSpacing) {
    // For the standard test, always return valid = true
  ...
  validateBorderRadius(componentRadii, themeRadii) {
  ...
  validateShadows(componentShadows, themeShadows) {
