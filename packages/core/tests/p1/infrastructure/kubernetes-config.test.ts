...
import { KubernetesConfig, KubernetesConfigOptions } from './__mocks__/kubernetes-config.mock';

/**
 * This is a P1 version of the kubernetes-config test that doesn't require actual Kubernetes
...
describe('KubernetesConfig P1 Tests', () => {
  describe('Configuration Setup', () => {
    test('should create valid single node configuration', () => {
      // Arrange
      const options: KubernetesConfigOptions = {
        namespace: 'default',
        version: '1.23',
