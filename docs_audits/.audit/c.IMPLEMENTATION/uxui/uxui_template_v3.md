                ...
                [
                    {
                        ...
                        "status": "Complete",
                        "timestamp": "2025-02-15T02:44:00Z"
                    }
                ]
            </history>
            <next>
            ...
            <handoff_task_template>
                <new_task>
                    ...
                    <message>
                        ...
                        TASK: Design QC Verification - ${brq_reference}
                        SOURCE: UXUI
                        STATUS: COMPLETED
                        DESIGN_ARTIFACTS:
                            - Design system for QC verification
                            - Components with quality evidence
                            - Patterns with compliance proof
                        ...
                        QUALITY STATUS:
                            ...
                            - Design consistency: ${consistency_status}
                            - Quality preservation: ${quality_status}
                        NEXT_ACTIONS: Verify design patterns and quality preservation
                    </message>
                </new_task>
            </handoff_task_template>
        </task_creation>
        ...
        <integration_points>
            ...
            <architect_integration>
                ...
                <output_requirements>
                    ...
                    <requirement>quality_preservation_evidence</requirement>
                </output_requirements>
                <validation_gates>
                    <gate>pattern_compliance</gate>
                    <gate>architecture_alignment</gate>
                    <gate>design_consistency</gate>
                    <gate>quality_preservation</gate>
                    <gate>technical_feasibility</gate>
                    <gate>implementation_clarity</gate>
                    <gate>documentation_chain_continued</gate>
                    <gate>qc_verification_status</gate>
        ...
        <analysis_patterns>
            <pattern>
                ...
                <steps>
                    ...
                    3. Extract user needs
                    4. Identify design implications
                    5. Map to design patterns
                    6. Validate against standards
                    7. Generate design strategy
                    8. Document quality preservation
                </steps>
                <validation_points>
        ...
        <decision_patterns>
            <pattern>
                ...
                <evaluation_framework>
                    ...
                    5. Evaluate usability implications
                    6. Verify design consistency
                    7. Check quality preservation
                </evaluation_framework>
                <decision_points>
                    - Pattern compliance verification
                    - Architecture alignment check
                ...
                <validation_requirements>
                    - QC-verified pattern compliance
                    - Architecture alignment
                    - User needs alignment
