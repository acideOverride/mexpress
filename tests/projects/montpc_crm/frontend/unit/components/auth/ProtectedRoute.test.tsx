// This is a migrated test from the project-specific location
// See: /opt/mExpress/projects/montpc_crm/tests/frontend/p0/components/auth/ProtectedRoute.test.tsx
