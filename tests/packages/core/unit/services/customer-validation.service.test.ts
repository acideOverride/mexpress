import { CustomerValidationService, CustomerInput } from '@mexpress/core/services/validation/customer-validation.service';
import { CustomerModel } from '@mexpress/core/models/customer';
import { Model } from 'mongoose';

// Mock the entire CustomerModel
jest.mock('@mexpress/core/models/customer', () => ({
  CustomerModel: {
    findOne: jest.fn()
  }
}));
